...
// NOTE: from circom, edited to take wasmFileName instead of wasm code
module.exports = async function builder(wasmFileName, options) {
  ...
  // TODO: make sure the right thing is being used below
